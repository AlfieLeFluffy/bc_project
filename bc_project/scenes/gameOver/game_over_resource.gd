...
const info: Dictionary = {
	...
	e_GameOverType.RETIRED : {"name":"RETIREMENT_GAME_OVER_NAME", "description": "RETIREMENT_GAME_OVER_DESCRIPTION", "color":Color.DARK_RED, "icon" : null, "achievement": AchievementsResource.e_AchievementType.RETIREMENT},
}
