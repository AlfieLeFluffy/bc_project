...
func _ready() -> void:
	...
	set_input_help_label(GameController.get_input_key_list("table_toggle"), "Detective Board")
	set_input_help_label(GameController.get_input_key_list("timeline_shift"), "Timeline Shift")
